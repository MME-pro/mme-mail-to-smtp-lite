...
class Microsoft_OAuth extends Abstract_Provider {
	...
	public function get_label(): string {
		return __( 'Microsoft (own auth app)', 'modern-mailer-oauth' );
	}
	...
	public static function describe(): array {
		return [
			'label'    => __( 'Microsoft (own auth app)', 'modern-mailer-oauth' ),
			'summary'  => __( 'Your own Entra app plus a one-time sign-in. No tenant ID and no administrator needed.', 'modern-mailer-oauth' ),
	...
	public static function fields(): array {
		return [
			...
			new Field(
				...
				secret: true,
				required: true,
				help: __( 'Copy the Value, not the Secret ID. Shown once.', 'modern-mailer-oauth' )
			),
		];
	}
