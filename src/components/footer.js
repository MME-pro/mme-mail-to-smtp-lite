 ...
 * never says anywhere else: who is responsible for it, where to go, and
 * who to write to when it is not behaving.
 *
...
const SUPPORT_EMAIL = 'support@mme-pro.de';
	...
	<footer className="mt-4 border-t border-border px-6 py-6 sm:px-8">
		<div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-xs text-muted-foreground">
			...
			<p className="m-0 sm:ml-auto">
				...
				{ /* A mailto rather than a page to hunt through. Somebody reading
				     a footer because something is wrong should be one click from
				     saying so, and the version sitting to the left of this is the
