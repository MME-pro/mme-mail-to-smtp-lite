...
for test in test-graph.php test-failures.php test-portal.php test-log-pagination.php test-forwarding.php test-alerts.php test-weekly-report.php test-gmail.php test-resilience.php test-google-consent.php test-smtp.php test-zoho.php test-microsoft-oauth.php test-disconnect.php test-privacy.php test-routing.php test-html-body.php test-regression-wpms.php test-final.php; do
	echo "--- ${test} ---"
