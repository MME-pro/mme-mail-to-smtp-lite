...
class Graph extends Abstract_Provider {
	...
	public static function describe(): array {
		return [
			...
			'summary'  => __( 'App-only through Microsoft Graph. Nothing expires but the client secret.', 'modern-mailer-oauth' ),
	...
	public static function fields(): array {
		return [
			...
			Field::secret( 'ms_client_secret', __( 'Client secret', 'modern-mailer-oauth' ), __( 'Copy the Value, not the Secret ID. Shown once.', 'modern-mailer-oauth' ) ),
