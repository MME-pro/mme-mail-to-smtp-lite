...
import { Inbox, Clock, XCircle, ArrowUpRight, ArrowRight, Wand2 } from 'lucide-react';
import { getDashboard } from '../api/client';
import { Panel, Badge, Button, Spinner, EmptyState } from '../components/ui';
				...
				<div>
					...
					<p className="mt-3 mb-0 max-w-[46ch] text-[13px] text-muted-foreground">
						{ health?.active
							...
							: __(
									'No provider configured, so WordPress is using the server mail function.',
									'modern-mailer-oauth'
							  ) }
					</p>
				</div>
