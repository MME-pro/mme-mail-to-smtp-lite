...
for test in test-graph.php test-failures.php test-gmail.php test-resilience.php test-google-consent.php test-smtp.php test-microsoft-oauth.php test-disconnect.php test-privacy.php test-html-body.php test-regression-wpms.php test-final.php; do
	echo "--- ${test} ---"
